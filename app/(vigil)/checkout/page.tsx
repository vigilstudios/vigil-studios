 ...
 */
export default async function CheckoutPage({ searchParams }: { searchParams: Promise<{ template?: string; client_reference_id?: string; canceled?: string }> }) {
  ...
  return (
    <CheckoutShell
      ...
      subtitle="One payment for the build, then a monthly Vigil plan that hosts, secures and operates it. You'll be in your dashboard in a minute."
    >
      {params.canceled ? (
