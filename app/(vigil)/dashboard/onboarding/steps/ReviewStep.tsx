...
import { briefCompletion, type Brief, type ProjectKind, type StepKey } from "@/lib/vigil/onboarding/brief";
...
export function ReviewStep({ brief, projectKind, assets, domain, onEdit, onSend, sending, error, onBack }: Props) {
  const missing = briefCompletion(brief, projectKind).filter((c) => !c.done);
  return (
    <div className="space-y-4">
      ...
      <BriefSummary brief={brief} projectKind={projectKind} assets={assets} domain={domain} onEdit={onEdit} />
